...
\begin{description}
  ...
  \item[Subjective Logic] \citep{josang2016subjective} introduces belief, disbelief, and
  ...
  \item[Truth Maintenance Systems] \citep{doyle1979truth,dekleer1986assumption} track dependencies
        but operate with binary in/out status rather than graded confidence,
        and were not designed for self-referential reasoning.

  \item[Justification Logic] \citep{artemov2001explicit} adds explicit proof terms but

...
Tarski's theorem on the undefinability of truth \citep{tarski1933concept} states that no
...
Extensive work exists on fuzzy modal logics \citep{caicedo2013finite}
...
By the theorem of Bou, Esteva, and Godo \citep{bou2011minimum}, many-valued modal
...
property via quasimodels \citep{caicedo2013finite}.
\end{theorem}
...
\citet{garrabrant2016logical} develop logical inductors
